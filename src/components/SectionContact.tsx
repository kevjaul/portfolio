...
function SectionContact() {
  ...
  return (
    <section
      ...
      className="scroll-mt-[100px] relative mt-10"
    >
      <div
        className="
    pointer-events-none absolute top-[-170px] left-0 w-full h-[170px]
    bg-gradient-to-b from-[#05010a]/0 to-[#05010a]/70 z-[-1]"
      />
      <div className="relative z-10 bg-[#05010a]/70 pb-10">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <input
                    name="email"
                    placeholder={
                      t("contact.contactForm.placeholderEmail") + "*"
                    }
                    className="bg-white/5 border border-white/10 p-3 rounded-lg"
                    required
                  />
